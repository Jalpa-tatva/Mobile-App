...
export const OverLayImage11: ImageStyle = {
  height: fontSize(45),
  width: fontSize(45),
  resizeMode: 'contain',
  borderRadius: fontSize(45 / 2),
...
export const SearchWrapperBox: ViewStyle = {
  width: '94%',
  height: fontSize(50),
  alignItems: 'center',
  // justifyContent: 'center',
  ...
  borderColor: color.searchIcon,
  shadowColor: color.searchIcon,
  shadowOffset: {
    width: 0,
    height: 2,
  },
...
export const SearchIconWrap: ViewStyle = {
  width: fontSize(40),
  height: fontSize(40),
